...
![Python](https://img.shields.io/badge/Python-3.10-blue) ![Streamlit](https://img.shields.io/badge/Frontend-Streamlit-red) ![Ollama](https://img.shields.io/badge/LLM-Llama3.1-orange) ![Status](https://img.shields.io/badge/Status-Active_Development-green)
...
**Key Differentiator:** Optimized for standard consumer hardware (GTX 1050 Ti) using custom batch processing and quantized models.
...
* **⚙️ Backend Verification:** Includes a `retrieve.py` diagnostic script to verify vector database integrity before launching the UI.

## 🛠️ Tech Stack
* **LLM Runtime:** [Ollama](https://ollama.com/) (Llama 3.1 - 8B Quantized)
...
* Pull the required models (Must use Llama 3.1 for best legal reasoning):
    ```bash
...
```bash
# CORRECT:
git clone https://github.com/ashwin-aiml-engineer/Local-Business-AI-Agent.git
...
Generation: System Prompt (Strict Lawyer) + Context + Question -> Llama 3.1 -> Answer.
